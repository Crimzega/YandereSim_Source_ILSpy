...
public class AttackManagerScript : MonoBehaviour
{
	...
	private void Update()
	{
		...
		if (Yandere.TargetStudent.StudentID == Yandere.StudentManager.RivalID)
		{
			if (AttackTimer < 1.5f)
			{
		...
		SpecialEffect(equippedWeapon, sanityType);
		if (YandereAnim[AnimName].time > YandereAnim[AnimName].length - 0.333333343f)
		{
	...
	private void SpecialEffect(WeaponScript weapon, SanityType sanityType)
	{
		...
		if (weapon.Type == WeaponType.Knife)
		{
			if (!Stealth)
			{
				...
				case SanityType.High:
					if (EffectPhase == 0 && YandereAnim[AnimName].time > 1.08333337f)
					{
				...
				case SanityType.Medium:
					if (EffectPhase == 0)
					{
						if (YandereAnim[AnimName].time > 2.16666675f)
						{
							Yandere.Bloodiness += 20f;
							Yandere.StainWeapon();
							UnityEngine.Object.Instantiate(BloodEffect, weapon.transform.position + weapon.transform.forward * 0.1f, Quaternion.identity);
				...
				if (EffectPhase == 0)
				{
					if (YandereAnim[AnimName].time > 2.76666665f)
					{
						Yandere.Bloodiness += 20f;
						Yandere.StainWeapon();
						UnityEngine.Object.Instantiate(BloodEffect, weapon.transform.position + weapon.transform.forward * 0.1f, Quaternion.identity);
				...
				else if (EffectPhase == 2 && YandereAnim[AnimName].time > 4.16666651f)
				{
					UnityEngine.Object.Instantiate(BloodEffect, weapon.transform.position + weapon.transform.forward * 0.1f, Quaternion.identity);
					EffectPhase++;
				}
		...
		else if (weapon.Type == WeaponType.Katana)
		{
			if (!Stealth)
			{
				...
				case SanityType.Medium:
					...
					else if (EffectPhase == 1 && YandereAnim[AnimName].time > 1.51666665f)
					{
						UnityEngine.Object.Instantiate(BloodEffect, weapon.transform.position + weapon.transform.forward * 0.5f, Quaternion.identity);
						EffectPhase++;
					}
				...
				{
					if (YandereAnim[AnimName].time > 2.33333325f)
					{
						UnityEngine.Object.Instantiate(BloodEffect, weapon.transform.position + weapon.transform.forward * (2f / 3f), Quaternion.identity);
						EffectPhase++;
					}
				...
				{
					if (YandereAnim[AnimName].time > 2.73333335f)
					{
						UnityEngine.Object.Instantiate(BloodEffect, weapon.transform.position + weapon.transform.forward * (2f / 3f), Quaternion.identity);
						EffectPhase++;
					}
				...
				{
					if (YandereAnim[AnimName].time > 3.13333344f)
					{
						UnityEngine.Object.Instantiate(BloodEffect, weapon.transform.position + weapon.transform.forward * (2f / 3f), Quaternion.identity);
						EffectPhase++;
					}
			...
			{
				UnityEngine.Object.Instantiate(BloodEffect, weapon.transform.position + weapon.transform.forward * 0.333333343f, Quaternion.identity);
				EffectPhase++;
			}
		}
		else if (weapon.Type == WeaponType.Bat)
		{
			if (!Stealth)
			{
				...
				{
					if (YandereAnim[AnimName].time > 3.76666665f)
					{
						UnityEngine.Object.Instantiate(BloodEffect, weapon.transform.position + weapon.transform.forward * 0.5f, Quaternion.identity);
						EffectPhase++;
					}
		...
		else if (weapon.Type == WeaponType.Saw)
		{
			if (!Stealth)
			{
				...
				case SanityType.High:
					...
					else if (EffectPhase == 2 && YandereAnim[AnimName].time > 1.43333328f)
					{
						weapon.Spin = false;
				...
				case SanityType.Medium:
					...
					{
						if (YandereAnim[AnimName].time > 1.43333328f)
						{
							weapon.BloodSpray[0].Stop();
							weapon.BloodSpray[1].Stop();
							EffectPhase++;
			...
			else if (EffectPhase == 0 && YandereAnim[AnimName].time > 1f)
			{
				Yandere.Bloodiness += 20f;
				Yandere.StainWeapon();
				UnityEngine.Object.Instantiate(BloodEffect, weapon.transform.position + weapon.transform.right * 0.2f + weapon.transform.forward * (-71f / (339f * (float)Math.PI)), Quaternion.identity);
				EffectPhase++;
			}
		}
		else if (weapon.Type == WeaponType.Weight)
		{
			if (!Stealth)
			{
				...
				case SanityType.Medium:
					...
					else if (EffectPhase == 1 && YandereAnim[AnimName].time > 2.83333325f)
					{
						UnityEngine.Object.Instantiate(BloodEffect, weapon.transform.position + weapon.transform.forward * 0.1f, Quaternion.identity);
						EffectPhase++;
					}
				...
				else if (EffectPhase == 1 && YandereAnim[AnimName].time > 4.16666651f)
				{
					UnityEngine.Object.Instantiate(BloodEffect, weapon.transform.position + weapon.transform.forward * 0.1f, Quaternion.identity);
					EffectPhase++;
				}
	...
	private void LoopCheck(WeaponScript weapon)
	{
		if (Input.GetButtonDown("X") && !Yandere.Chased && Yandere.Chasers == 0)
		{
			if (weapon.Type == WeaponType.Knife)
			{
				if (YandereAnim[AnimName].time > 3.5333333f && YandereAnim[AnimName].time < 4.16666651f)
				{
					LoopStart = 106f;
					LoopEnd = 125f;
					LoopPhase = 2;
			...
			{
				if (YandereAnim[AnimName].time > 3.36666656f && YandereAnim[AnimName].time < 3.9f)
				{
					LoopStart = 101f;
					LoopEnd = 117f;
					LoopPhase = 5;
			...
			{
				if (YandereAnim[AnimName].time > 3.76666665f && YandereAnim[AnimName].time < 4.4f)
				{
					LoopStart = 113f;
					LoopEnd = 132f;
					LoopPhase = 2;
