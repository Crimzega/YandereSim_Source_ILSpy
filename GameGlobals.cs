...
public static class GameGlobals
{
	...
	public static bool Eighties
	{
		get
		{
			return GlobalsHelper.GetBool("Profile_" + Profile + "_Eighties");
		}
		set
		{
			GlobalsHelper.SetBool("Profile_" + Profile + "_Eighties", value);
		}
	}
	...
	{
		return PlayerPrefs.GetInt("Profile_" + Profile + "_RivalEliminations" + elimID.ToString());
	}
	...
	{
		return PlayerPrefs.GetInt("Profile_" + Profile + "_SpecificEliminations" + elimID.ToString());
	}
