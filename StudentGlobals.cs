...
public static class StudentGlobals
{
	...
	{
		return GlobalsHelper.GetBool("Profile_" + GameGlobals.Profile + "_StudentPhoneStolen_" + studentID.ToString());
	}
	...
	{
		return GlobalsHelper.GetBool("Profile_" + GameGlobals.Profile + "_StudentRansomed_" + studentID.ToString());
	}
