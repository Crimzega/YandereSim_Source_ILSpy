...
public class AmbientEventScript : MonoBehaviour
{
	...
	private void Update()
	{
		...
		if (Clock.HourTime > StartTime + 0.5f || EventStudent[1].WitnessedCorpse || EventStudent[2].WitnessedCorpse || EventStudent[1].Alarmed || EventStudent[2].Alarmed || EventStudent[1].Dying || EventStudent[2].Dying || Yandere.Noticed)
		{
			EndEvent();
			return;
		}
