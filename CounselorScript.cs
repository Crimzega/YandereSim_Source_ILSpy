...
public class CounselorScript : MonoBehaviour
{
	...
	private string[] LectureIntro = new string[8] { "", "During class, the guidance counselor enters the classroom and says that she needs to speak with your rival...", "During class, the guidance counselor enters the classroom and says that she needs to speak with your rival...", "During class, the guidance counselor enters the classroom and says that she needs to speak with your rival...", "During class, the guidance counselor enters the classroom and says that she needs to speak with your rival...", "During class, the guidance counselor enters the classroom and says that she needs to speak with your rival...", "During class, the guidance counselor enters the classroom and says that she needs to speak with your rival...", "During class, the guidance counselor enters the classroom and says that she needs to speak with your rival..." };
			...
			else if (LecturePhase == 8)
			{
				...
				if (ExpelTimer > 6f)
				{
					...
					else if (!EndOfDay.Police.Show)
					{
						...
						else if (LectureID == 6 && !Eighties && StudentManager.RivalID == 11 && StudentManager.Students[10] != null)
						{
	...
	private void UpdateInterrogation()
	{
		...
		else if (InterrogationPhase == 2)
		{
			...
			if (Timer > MyAudio.clip.length + 0.5f)
			{
				...
				else if (Crime == StudentWitnessType.Insanity || Crime == StudentWitnessType.CleaningItem || Crime == StudentWitnessType.HoldingBloodyClothing || Crime == StudentWitnessType.Poisoning)
				{
		...
		else if (InterrogationPhase == 6)
		{
			...
			if (Timer > MyAudio.clip.length + 0.5f || Input.GetButtonDown("A"))
			{
				...
				else if (Answer == 4)
				{
					...
					bool flag5 = false;
					if ((CrimeID == 1 && CounselorGlobals.BloodBlameUsed > 1) || (CrimeID == 2 && CounselorGlobals.InsanityBlameUsed > 1) || (CrimeID == 3 && CounselorGlobals.LewdBlameUsed > 1) || (CrimeID == 4 && CounselorGlobals.TheftBlameUsed > 1) || (CrimeID == 5 && CounselorGlobals.TrespassBlameUsed > 1) || (CrimeID == 6 && CounselorGlobals.WeaponBlameUsed > 1))
					{
						flag5 = true;
					}
					if (flag4)
