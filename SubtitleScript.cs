...
public class SubtitleScript : MonoBehaviour
{
	...
	private void Awake()
	{
		if (GameGlobals.Eighties)
		{
			...
			Club1Info[1] = "This is the cooking club! Everyone here enjoys preparing food! We also like to hang out our food to people around school!";
			...
			BreakingUp[1] = "Cease immediately.";
			BreakingUp[2] = "Do not fight!";
			...
			CouncilCorpseReactions[2] = "Você está morto?!";
			...
			StrictReport[2] = "I found a dead body! Come with me!";
			StrictReport[3] = "Impossible...";
			CasualReport[1] = "Devo contar a um professor!";
			CasualReport[2] = "Emergency! Dead body! Follow me!";
			CasualReport[3] = "Que diabos está acontecendo aqui...";
