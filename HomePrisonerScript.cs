...
public class HomePrisonerScript : MonoBehaviour
{
	...
	private void Update()
	{
		...
		if (ID == 1)
		{
			...
			StudentGlobals.SetStudentSanity(SchoolGlobals.KidnapVictim, Sanity - 2f - (float)(ClassGlobals.PsychologyGrade * 10));
		}
		else if (ID == 2)
		{
			...
			StudentGlobals.SetStudentSanity(SchoolGlobals.KidnapVictim, Sanity - 8f - (float)(ClassGlobals.PsychologyGrade * 10));
		}
		else if (ID == 3)
		{
			HomeGlobals.Night = true;
			SceneManager.LoadScene("HomeScene");
			StudentGlobals.SetStudentSanity(SchoolGlobals.KidnapVictim, Sanity - 24f - (float)(ClassGlobals.PsychologyGrade * 10));
		...
		else if (ID == 4)
		{
			...
			SceneManager.LoadScene("CalendarScene");
			StudentGlobals.SetStudentSanity(SchoolGlobals.KidnapVictim, Sanity - 36f);
			PlayerGlobals.Reputation -= 20f;
		}
