...
public class TimelineScript : MonoBehaviour
{
	...
	private void Start()
	{
		...
		Height -= 100;
		SpawnYear(1979);
		SpawnSaikouData("Saisho Corp releases the world's first portable cassette tape player.");
		Height -= 150;
		SpawnSaikouData("Saisho Saikou's son is born. He is named Ichiro.");
		Height -= 150;
		SpawnYear(1981);
		...
		SpawnSaikouData("Ichiro Saikou enrolls in Akademi.");
		Height -= 150;
		SpawnYear(2003);
		...
		Height -= 100;
		SpawnYear(2004);
		SpawnSaikouData("Ichiro Saikou's daughter is born. She is named Megami.");
		...
		Height -= 150;
		SpawnYear(2006);
		SpawnSaikouData("Ichiro Saikou's son is born. He is named Kencho.");
		Height -= 150;
		SpawnYear(2019);
		SpawnSaikouData("Saisho Saikou steps down as CEO of Saikou Corp and appoints his son Ichiro as the new CEO.");
		Height -= 200;
		SpawnYear(2020);
		...
		Long = true;
		Height -= 100;
		SpawnMiscData("The Saikou family announces to the world that Saisho Saikou has passed away at the age of 94.");
		Height -= 150;
		Hide = true;
	...
	private void SpawnYear(int Year)
	{
		...
		obj.GetComponent<UILabel>().text = string.Concat(Year);
		Height -= 50;
	}
