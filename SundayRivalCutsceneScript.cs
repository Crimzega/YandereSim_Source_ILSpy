...
public class SundayRivalCutsceneScript : MonoBehaviour
{
	...
	private void Update()
	{
		...
		else if (Phase == 4)
		{
			...
			HomeYandere.HomeCamera.transform.position = Vector3.Lerp(HomeYandere.HomeCamera.transform.position, new Vector3(-1.966666f, 1.07f, 1.94333327f), Time.deltaTime * Speed);
