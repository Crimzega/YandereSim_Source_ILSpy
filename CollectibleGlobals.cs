...
public static class CollectibleGlobals
{
	...
	{
		return GlobalsHelper.GetBool("Profile_" + GameGlobals.Profile + "_GiftPurchased_" + giftID.ToString());
	}
	...
	{
		return GlobalsHelper.GetBool("Profile_" + GameGlobals.Profile + "_GiftGiven_" + giftID.ToString());
	}
	...
	{
		return GlobalsHelper.GetBool("Profile_" + GameGlobals.Profile + "_PantyPurchased_" + giftID.ToString());
	}
	...
	{
		return GlobalsHelper.GetBool("Profile_" + GameGlobals.Profile + "_AdvicePurchased_" + giftID.ToString());
	}
