...
public static class PlayerGlobals
{
	...
	{
		return GlobalsHelper.GetBool("Profile_" + GameGlobals.Profile + "_StudentPantyShot_" + studentID.ToString());
	}
	...
	{
		return GlobalsHelper.GetBool("Profile_" + GameGlobals.Profile + "_ShrineCollectible_" + ID.ToString());
	}
	...
	{
		return GlobalsHelper.GetBool("Profile_" + GameGlobals.Profile + "_CannotBringItem" + ID.ToString());
	}
