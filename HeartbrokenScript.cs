...
public class HeartbrokenScript : MonoBehaviour
{
	...
	public void Darken()
	{
		for (int i = 0; i < Letters.Length; i++)
		{
			...
			Letters[i].color = new Color(1f, 0f, 0f, Letters[i].color.a - 0.05882353f);
		}
		for (int i = 0; i < 4; i++)
		{
			...
			Options[i].color = new Color(Options[i].color.r, Options[i].color.g, Options[i].color.b, Options[i].color.a - 0.05882353f);
		}
	}
}
