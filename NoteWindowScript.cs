		...
		if (!Selecting)
		{
			...
			if (Input.GetButtonDown("X") && SlotsFilled[1] && SlotsFilled[2] && SlotsFilled[3])
			{
				...
				else
				{
					...
					{
						if (SlotLabels[1].text == Subjects[9])
						{
					...
					{
						if (NoteLocker.Student.Bullied && SlotLabels[1].text == Subjects[7] && MeetID > 7)
						{
							NoteLocker.Success = true;
						}
					}
					else if (NoteLocker.Student.StudentID == Yandere.StudentManager.RivalID && SlotLabels[1].text == Subjects[10])
					{
						NoteLocker.Success = true;
					...
					if (NoteLocker.Student.Persona == PersonaType.Loner || NoteLocker.Student.Persona == PersonaType.Sleuth)
					{
						if (SlotLabels[1].text == Subjects[1])
						{
							NoteLocker.Success = true;
						}
					}
					...
					else if (NoteLocker.Student.Persona == PersonaType.Coward || NoteLocker.Student.Persona == PersonaType.Sleuth)
					{
						if (SlotLabels[1].text == Subjects[1] || SlotLabels[1].text == Subjects[4])
						{
							NoteLocker.Success = true;
						}
					}
					else if (NoteLocker.Student.Persona == PersonaType.SocialButterfly || NoteLocker.Student.Persona == PersonaType.Sleuth)
					{
						if (SlotLabels[1].text == Subjects[5])
						{
							NoteLocker.Success = true;
						}
					}
					...
					else if (NoteLocker.Student.Club == ClubType.Bully && (SlotLabels[1].text == Subjects[5] || SlotLabels[1].text == Subjects[10]))
					{
						NoteLocker.Success = true;
					}
