...
public class WeaponMenuScript : MonoBehaviour
{
	...
	private void Update()
	{
		...
		{
			if ((Yandere.CanMove && !Yandere.Aiming) || (Yandere.Chased && !Yandere.Struggling && !Yandere.Sprayed && !Yandere.DelinquentFighting))
			{
				...
				if (!Yandere.EasterEggMenu.activeInHierarchy && (Input.GetKeyDown(KeyCode.Alpha1) || Input.GetKeyDown(KeyCode.Alpha2) || Input.GetKeyDown(KeyCode.Alpha3) || Input.GetKeyDown(KeyCode.Alpha4) || Input.GetKeyDown(KeyCode.Alpha5) || Input.GetKeyDown(KeyCode.Alpha6)))
				{
					Yandere.EmptyHands();
