...
public class UISprite : UIBasicSprite
{
	...
	public override Material material
	{
		get
		{
			...
			return (mAtlas as INGUIAtlas)?.spriteMaterial;
		}
		set
		{
			base.material = value;
	...
	public override float pixelSize
	{
		get
		{
			...
			return (mAtlas as INGUIAtlas)?.pixelSize ?? 1f;
		}
	}
	...
	public override bool premultipliedAlpha => (mAtlas as INGUIAtlas)?.premultipliedAlpha ?? false;
