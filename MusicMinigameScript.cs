	...
	private void Update()
	{
		...
		if (!Won)
		{
			...
			else
			{
				...
				if (MyAudio.time > 33f && MyAudio.time < 36.8333321f)
				{
					ChibiSway[1] = true;
				}
				...
				else if (MyAudio.time > 46.8333321f && MyAudio.time < 49.75f)
				{
					ChibiSway[1] = true;
				}
				else if (MyAudio.time > 50.3833351f && MyAudio.time < 53f)
				{
					ChibiSway[1] = true;
				}
				else if (MyAudio.time > 53.9166679f && MyAudio.time < 59f)
				{
					ChibiSway[1] = true;
				}
				...
				else if (MyAudio.time > 84.05f && MyAudio.time < 88.1666641f)
				{
					ChibiSway[1] = true;
				}
				...
				else if (MyAudio.time > 101.833336f && MyAudio.time < 130.583328f)
				{
					ChibiSway[1] = true;
				}
				else
		...
		if (Timer == 0f)
		{
			CurrentRep.text = string.Concat(StartRep);
			if (Health > 100f)
			{
		...
		if (Timer > 1f && Health > 100f)
		{
			...
			CurrentRep.text = string.Concat(num);
