...
public class ScheduleScript : MonoBehaviour
{
	...
	{
		Header.text = string.Concat(Weekday, " Schedule");
		...
		EventIcons[37].SetActive(value: true);
		Descriptions[37] = "Before eating lunch, Sakyu is going to remove the large, gaudy ring that she usually wears.";
