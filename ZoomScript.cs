...
public class ZoomScript : MonoBehaviour
{
	...
	private void Update()
	{
		...
		if (!Yandere.FollowHips)
		{
			...
			{
				base.transform.localPosition = new Vector3(base.transform.localPosition.x, Mathf.MoveTowards(base.transform.localPosition.y, Height + Zoom, Time.deltaTime), base.transform.localPosition.z);
			}
		}
