...
public class OsanaPoolEventScript : MonoBehaviour
{
	...
	private void Update()
	{
		if (Phase == 0)
		{
			if (Frame > 0 && StudentManager.Students[RivalID] != null && StudentManager.Students[RivalID].enabled && Clock.Period == 3)
			{
		...
		if (Clock.HourTime > 13.5f || Rival.Alarmed || Rival.Splashed)
		{
			EndEvent();
		}
