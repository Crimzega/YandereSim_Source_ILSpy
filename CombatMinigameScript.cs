...
public class CombatMinigameScript : MonoBehaviour
{
	...
	private void Update()
	{
		...
		else if (Path == 4)
		{
			...
			if (!Practice)
			{
				ScheduleBlock obj = Delinquent.ScheduleBlocks[2];
				obj.destination = "Sulk";
				obj.action = "Sulk";
				ScheduleBlock obj2 = Delinquent.ScheduleBlocks[4];
				obj2.destination = "Sulk";
				obj2.action = "Sulk";
				ScheduleBlock obj3 = Delinquent.ScheduleBlocks[6];
				obj3.destination = "Sulk";
				obj3.action = "Sulk";
				ScheduleBlock obj4 = Delinquent.ScheduleBlocks[7];
