...
public class MissionModeScript : MonoBehaviour
{
	...
	private void Update()
	{
		...
		else
		{
			...
			if (Timer > 1f)
			{
				...
				{
					Darkness.color = new Color(Darkness.color.r, Darkness.color.g, Darkness.color.b, Mathf.MoveTowards(Darkness.color.a, 1f, 0.0166666675f));
					Jukebox.Dip = Mathf.MoveTowards(Jukebox.Dip, 0f, 0.0166666675f);
	...
	private void Success()
	{
		...
		DiscordCodeLabel.text = string.Concat(RandomNumber);
